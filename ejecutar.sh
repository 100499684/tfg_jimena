...
#SBATCH --job-name=train_comb
#SBATCH --output=Estudios/terminal/process.EfficientNet_comb_text_train.%j.out
#SBATCH --error=Estudios/terminal/process.EfficientNet_comb_text_train.%j.err
#SBATCH --gres=gpu:1
