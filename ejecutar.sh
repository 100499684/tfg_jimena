...
#SBATCH --job-name=test_ini
#SBATCH --output=Estudios/terminal/process.EfficientNet_Principal_Test.%j.out
#SBATCH --error=Estudios/terminal/process.EfficientNet_Principal_Test.%j.err
#SBATCH --gres=gpu:1
